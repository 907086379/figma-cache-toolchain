...
## Encoding And Anti-Mojibake (Required)
- When creating or updating README.md, mdc, SKILL.md, and json docs, write files using UTF-8 only.
- Node writes must set utf8 explicitly and PowerShell writes must include -Encoding utf8 or -Encoding utf8BOM.
- Never save content after seeing encoding artifacts in terminal output.
- If mojibake is detected, recover from a clean source and rewrite with UTF-8.
- Minimum acceptance check for doc changes: sample read at least 20 lines and confirm readability.
